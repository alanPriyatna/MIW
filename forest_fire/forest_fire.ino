/*Fire Alarm System
  Turns on Buzzer when fire is detected.
...
float maxTemp = 50;   //min temperature in case of fire
float minHum = 12;    //ma humidity in case of fire
...
void loop()
{
    int co2 = CO2_sensor();   //read co2 ppm
    DHT_sensor();   //read temp-humidity
